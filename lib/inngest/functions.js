...
export const generateIndustryInsights = inngest.createFunction(
  { id: "generate-industry-insights", name: "Generate Industry Insights", cron: "0 0 * * 0" }, // Run every Sunday at midnight
  async ({ event, step }) => {
...
export const processNewUserOnboarding = inngest.createFunction(
  { id: "process-new-user-onboarding", name: "Process New User Onboarding", event: "user/created" },
  async ({ event, step }) => {
...
export const generateInterviewQuestions = inngest.createFunction(
  { id: "generate-interview-questions", name: "Generate Interview Questions", event: "interview/practice-requested" },
  async ({ event, step }) => {
...
export const analyzeCoverLetterPerformance = inngest.createFunction(
  { id: "analyze-cover-letter-performance", name: "Analyze Cover Letter Performance", event: "cover-letter/created" },
  async ({ event, step }) => {
